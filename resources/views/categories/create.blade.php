<x-layout>
    <div class="max-w-lg mx-auto bg-white p-8 rounded-xl shadow-md">
        <h2 class="text-2xl font-bold mb-6 text-gray-800">Tambah Jenis</h2>
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" class="w-full border rounded px-3 py-2 focus:outline-blue-500" required placeholder="Contoh: Elektronik, Pipa, Cat">
